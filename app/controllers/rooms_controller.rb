class RoomsController < ApplicationController
  ...
  def vacancies
    @rooms = Room.vacancy_list
    
    respond_to do |format|
      format.html
      format.pdf do
        html = render_to_string(:layout => false, :action => "vacancies.html.erb")
        # many other options
        ...
        send_data kit.to_pdf, filename: "vacancies as of #{Date.today}.pdf", type: "application/pdf", disposition: "inline"
      end
    end
  end
