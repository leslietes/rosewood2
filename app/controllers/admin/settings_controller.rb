class Admin::SettingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @setting.save
        format.html { redirect_to admin_setting_url, notice: 'Setting was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @setting.update(setting_params)
        format.html { redirect_to admin_setting_url, notice: 'Settings were successfully updated.' }
