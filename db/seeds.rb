...
Utility.create(name: 'Lost Key',       category: 'Extra', description: "",                       first_rate: 150,        unit: 'per key',   user_id: 1)
Utility.create(name: 'Locked Out',     category: 'Extra', description: "lock out penalty",       first_rate: 80,         unit: 'per instance',user_id: 1)

Occupant.create(first_name: 'Racquel',      last_name: 'Tecson',    user_id: 1)
Occupant.create(first_name: 'S',            last_name: 'Zapanta',   user_id: 1)
Occupant.create(first_name: 'S',            last_name: 'Perez',     user_id: 1)
Occupant.create(first_name: 'E',            last_name: 'Sia',       user_id: 1)
Occupant.create(first_name: 'S',            last_name: 'Yap',       user_id: 1)
...
Occupant.create(first_name: 'C',            last_name: 'Escabarte', user_id: 1)
Occupant.create(first_name: 'K',            last_name: 'Ocariza',   user_id: 1)
...
Occupant.create(first_name: 'D',            last_name: 'Sosobrado', user_id: 1)
...
Occupant.create(first_name: 'R',            last_name: 'Doruelo',   user_id: 1)
Occupant.create(first_name: 'L',            last_name: 'Lumacad',   user_id: 1)
Occupant.create(first_name: 'H',            last_name: 'Acobo',     user_id: 1)
Occupant.create(first_name: 'E',            last_name: 'Badal',     user_id: 1)
...
Occupant.create(first_name: 'K',            last_name: 'Wong',      user_id: 1)
...
Occupant.create(first_name: 'C',            last_name: 'Carias',    user_id: 1)
...
Occupant.create(first_name: 'M',            last_name: 'Lee',       user_id: 1)
Occupant.create(first_name: 'I',            last_name: 'Lee',       user_id: 1)
...
Occupant.create(first_name: 'N',            last_name: 'Bungabong', user_id: 1)
Occupant.create(first_name: 'J',            last_name: 'Ferniz',    user_id: 1)
Occupant.create(first_name: 'M',            last_name: 'Martin',    user_id: 1)
Occupant.create(first_name: 'Janine Marie', last_name: 'Bernanga',  user_id: 1)
Occupant.create(first_name: 'E',            last_name: 'Ocampo',    user_id: 1)
Occupant.create(first_name: 'E',            last_name: 'Ocampo',    user_id: 1)
Occupant.create(first_name: 'Tatara Yukari',last_name: 'Priete',    user_id: 1)
Occupant.create(first_name: 'Gala Gay',     last_name: 'Bolen',     user_id: 1)
Occupant.create(first_name: 'K',            last_name: 'Inferido',  user_id: 1)
Occupant.create(first_name: 'K',            last_name: 'Inferido',  user_id: 1)
Occupant.create(first_name: 'M',            last_name: 'Tirol',     user_id: 1)
Occupant.create(first_name: 'L',            last_name: 'Ebarsabal', user_id: 1)
Occupant.create(first_name: 'C',            last_name: 'Ebarsabal', user_id: 1)
Occupant.create(first_name: 'M',            last_name: 'Gonzales',  user_id: 1)
Occupant.create(first_name: 'M',            last_name: 'Gumop-as',  user_id: 1)