...
Utility.create(name: 'Electricity',           category: 'basic', description: "Monthly. Per kilowatt hour", rate: 450, unit: 'per kwh')
Utility.create(name: 'Water Basic',           category: 'basic', description: "Monthly. First 10 cubic meter", rate: 150, unit: 'first 10 cubic meter')
Utility.create(name: 'Water Excess',          category: 'basic', description: "Monthly. Excess of 10 cubic meter", rate: 450, unit: 'per cubic meter')
Utility.create(name: 'Cable TV Subscription', category: 'extra', description: "Monthly fee", rate: 450, unit: 'per month')
Utility.create(name: 'Cable TV Installation', category: 'extra', description: "One time fee", rate: 450, unit: 'one time')
Utility.create(name: 'Cable TV Termination',  category: 'extra', description: "One time fee", rate: 450, unit: 'one time')
Utility.create(name: 'Water Commercial Basic',category: 'basic', description: "Monthly. First 10 cubic meter", rate: 450, unit: 'first 10 cubic meter')
Utility.create(name: 'Water Commercial Excess',category:'basic', description: "Monthly. Excess of 10 cubic meter", rate: 450, unit: 'per cubic meter')

Utility.create(name: 'Parking Fee',    category: 'extra', description: "Monthly parking fee",    rate: 2000, unit: 'per month')
Utility.create(name: 'Transcient Fee', category: 'extra', description: "Extra person per night", rate: 250,  unit: 'per night')
Utility.create(name: 'Penalty',        category: 'extra', description: "Past due penalty",       rate: 100,  unit: 'per day')
Utility.create(name: 'Damages',        category: 'extra', description: "Rate depending on damage",           unit: 'per damage')
Utility.create(name: 'Cleaning Fee',   category: 'extra', description: "Out-of-cycle cleaning request", rate: 350, unit: 'per room')