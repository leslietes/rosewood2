...
Utility.create(name: 'Cable TV Subscription', category: 'Bxtra', description: "Monthly fee", rate: 450, unit: 'per month')
Utility.create(name: 'Cable TV Installation', category: 'Bxtra', description: "One time fee", rate: 450, unit: 'one time')
Utility.create(name: 'Cable TV Termination',  category: 'Bxtra', description: "One time fee", rate: 450, unit: 'one time')
